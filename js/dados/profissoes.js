...
export const PROFISSOES = [
  ...
  },
  {
    ...
    requisito: "Máquinas",
    habilidades: [
      { nivel: 1,  nome: "Reparar Veículo",    desc: "Pode rolar dados de vida pro veículo 1× por cena." },
      { nivel: 5,  nome: "Veículo Reforçado",  desc: "Gaste 2 ações: reforça o veículo. Testes de defesa do veículo recebem ganho no combate." },
      ...
      { nivel: 15, nome: "Mestre Carpinteiro", desc: "Modificações permanentes no veículo (1M de bellys por descanso longo). Pode aumentar 1D6 de atributo do navio." }
    ]
  },
  {
    id: "engenheiro",
    ...
    habilidades: [
      ...
      { nivel: 10, nome: "Autômatos",     desc: "Cria um robô auxiliar (1D + HABILIDADE em testes, 10 PV) para funções do navio." },
  ...
  },
  {
    ...
    habilidades: [
      ...
      { nivel: 15, nome: "Entre a Faca e o Queijo", desc: "Descanso longo inteiro: cria 1 alimento especial que recupera metade do PA máximo." }
    ]
  },
  {
    id: "medico",
    ...
    habilidades: [
      ...
      { nivel: 15, nome: "Eu Estou Aqui Para Salvar", desc: "1× por dia: converte 1/4 do seu PM máximo em PV para um aliado próximo." }
    ]
  },
  {
    ...
    requisito: "Percepção",
    habilidades: [
      { nivel: 1,  nome: "Marcado",          desc: "1× por dia: seleciona um alvo. Ganho em testes para rastreá-lo por 24h." },
  ...
  },
  {
    ...
    requisito: "Artes",
    habilidades: [
      { nivel: 1,  nome: "Canção da Batalha", desc: "1× por rodada: gaste ação, teste Artes (12) → aliados recebem 5 PM. Perfeito: +1 PA de bônus." },
  ...
  },
  {
    ...
    requisito: "Máquinas",
    habilidades: [
      { nivel: 1,  nome: "Em Altas Rotas",       desc: "Ganho em testes de pilotagem em movimento. Sem percas por rotas complicadas." },
      { nivel: 5,  nome: "Manobras Evasivas",    desc: "Em conflito pilotando: libera as 3 formas de defesa padrão pro veículo (HABILIDADE do personagem)." },
